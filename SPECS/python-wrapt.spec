...
Summary:          PackYak automated build of package = wrapt (1.12.1)
...
%files -n  python3-bio-wrapt -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [wrapt] version [1.12.1] by PackYak v0.0.7
