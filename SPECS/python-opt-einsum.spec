...
Summary:          PackYak automated build of package = opt-einsum (3.3.0)
...
Summary:        %{summary}
Provides:         python3.8dist(opt-einsum)
...
%files -n  python3-bio-opt-einsum -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [opt-einsum] version [3.3.0] by PackYak v0.0.7
