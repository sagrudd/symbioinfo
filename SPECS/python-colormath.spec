...
Source0:          https://files.pythonhosted.org/packages/ce/cf/70ea34103a76cc6fb1892289bda321cd0cc73b1a5500ee7fe9ef9f64acef/colormath-3.0.0.tar.gz
License:          BSD License (BSD)
URL:              https://pypi.org/project/colormath/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = colormath (3.0.0)
...
Summary:        %{summary}
Provides:         python3.8dist(colormath)
...
%files -n  python3-bio-colormath -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [colormath] version [3.0.0] by PackYak v0.0.7
