...
Source0:          https://files.pythonhosted.org/packages/d8/45/de59861abc8cb66e9e95c02b214be4d52900aa92ce34241a957dcf1d569d/anytree-2.8.0.tar.gz
License:          Apache 2.0
URL:              https://pypi.org/project/anytree/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [anytree] version [2.8.0]
...
Summary:          PackYak v0.0.6 build of Python package [anytree] version [2.8.0]
BuildRequires:    python3.8 python-six
Requires:         python3.8 python-six
