...
Source0:          https://files.pythonhosted.org/packages/ab/0c/28347673b45e5f0975cdf1f6d69ede6ad049be873194c4e164d79aecd34c/lzstring-1.0.4.tar.gz
License:          MIT License
URL:              https://pypi.org/project/lzstring/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = lzstring (1.0.4)
...
Summary:        %{summary}
Provides:         python3.8dist(lzstring)
...
%files -n  python3-bio-lzstring -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [lzstring] version [1.0.4] by PackYak v0.0.7
