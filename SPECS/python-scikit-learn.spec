...
Source0:          https://files.pythonhosted.org/packages/f4/7b/d415b0c89babf23dcd8ee631015f043e2d76795edd9c7359d6e63257464b/scikit-learn-0.24.1.tar.gz
License:          OSI Approved (new BSD)
URL:              https://pypi.org/project/scikit-learn/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = scikit-learn (0.24.1)
...
Summary:        %{summary}
Provides:         python3.8dist(scikit-learn)
...
%files -n  python3-bio-scikit-learn -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [scikit-learn] version [0.24.1] by PackYak v0.0.7
