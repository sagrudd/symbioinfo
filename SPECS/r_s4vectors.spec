...
Source0:          https://www.bioconductor.org/packages/release/bioc/html/../src/contrib/S4Vectors_0.28.1.tar.gz
License:          Artistic-2.0
URL:              https://www.bioconductor.org/packages/release/bioc/html/S4Vectors.html
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.2 build of R-package [S4Vectors] version [0.28.1]
Provides:         R(%{packname})
...
- updated [S4Vectors] package version to [0.28.1-1] by PackYak v0.0.2
