...
Summary:          PackYak automated build of package = cachetools (4.2.1)
...
Summary:        %{summary}
Provides:         python3.8dist(cachetools)
...
%files -n  python3-bio-cachetools -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [cachetools] version [4.2.1] by PackYak v0.0.7
