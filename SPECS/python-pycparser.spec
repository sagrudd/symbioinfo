...
Summary:          PackYak v0.0.6 build of Python package [pycparser] version [2.20]
...
%files -n python3-bio-pycparser
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Fri Feb 5 2021  <>
- updated [pycparser] package version to [2.20-1] by PackYak v0.0.6
