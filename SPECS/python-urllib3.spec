...
Summary:          PackYak automated build of package = urllib3 (1.26.3)
...
Summary:        %{summary}
Provides:         python3.8dist(urllib3)
...
%files -n  python3-bio-urllib3 -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [urllib3] version [1.26.3] by PackYak v0.0.7
