...
Summary:          PackYak v0.0.6 build of Python package [urllib3] version [1.26.3]
...
%files -n python3-bio-urllib3
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Fri Feb 5 2021  <>
- updated [urllib3] package version to [1.26.3-1] by PackYak v0.0.6
