...
Summary:          PackYak automated build of package = PyYAML (5.4.1)
...
%files -n  python3-bio-PyYAML -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [PyYAML] version [5.4.1] by PackYak v0.0.7
