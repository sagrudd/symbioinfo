...
Summary:          PackYak automated build of package = iniconfig (1.1.1)
...
Summary:        %{summary}
Provides:         python3.8dist(iniconfig)
...
%files -n  python3-bio-iniconfig -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [iniconfig] version [1.1.1] by PackYak v0.0.7
