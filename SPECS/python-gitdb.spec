...
Summary:          PackYak automated build of package = gitdb (4.0.5)
...
%files -n  python3-bio-gitdb -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [gitdb] version [4.0.5] by PackYak v0.0.7
