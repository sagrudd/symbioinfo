...
Summary:          PackYak v0.0.2 build of R-package [diffobj] version [0.3.3]
Provides:         R(%{packname})
BuildRequires:    tex(latex) R-core = %{rversion} r_crayon
Requires:         tex(latex) R-core = %{rversion} r_crayon
...
- updated [diffobj] package version to [0.3.3-1] by PackYak v0.0.2
