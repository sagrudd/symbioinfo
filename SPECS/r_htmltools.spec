...
Source0:          https://cran.r-project.org/web/packages/htmltools/../../../src/contrib/htmltools_0.5.1.1.tar.gz
...
- updated [htmltools] package version to [0.5.1.1-1] by PackYak v0.0.5
