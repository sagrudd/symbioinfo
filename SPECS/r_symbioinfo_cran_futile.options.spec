...
Name:             r_symbioinfo_cran_futile.options
Version:          1.0.1
...
Summary:          PackYak v0.0.1.9005 build of R-package [futile.options] version [1.0.1]
...
- updated [futile.options] package version to [1.0.1-1] by PackYak v0.0.1.9005
