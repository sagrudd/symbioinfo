...
Source0:          https://files.pythonhosted.org/packages/7f/69/2acf801ff56af4cca6a2d0e17108770c42eeb5596919254c5acbcf23efaf/plotly-4.14.3.tar.gz
License:          MIT
URL:              https://pypi.org/project/plotly/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = plotly (4.14.3)
...
%files -n  python3-bio-plotly -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [plotly] version [4.14.3] by PackYak v0.0.7
