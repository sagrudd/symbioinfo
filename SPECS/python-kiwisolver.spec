...
Source0:          https://files.pythonhosted.org/packages/90/55/399ab9f2e171047d28933ae4b686d9382d17e6c09a01bead4a6f6b5038f4/kiwisolver-1.3.1.tar.gz
License:          BSD License (BSD)
URL:              https://pypi.org/project/kiwisolver/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = kiwisolver (1.3.1)
...
%files -n  python3-bio-kiwisolver -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [kiwisolver] version [1.3.1] by PackYak v0.0.7
