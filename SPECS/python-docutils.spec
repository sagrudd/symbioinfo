...
License:          BSD License, GNU General Public License (GPL), Python Software Foundation License, Public Domain (public domain, Python, 2-Clause BSD, GPL 3 (see COPYING.txt))
URL:              https://pypi.org/project/docutils/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = docutils (0.16)
...
Summary:        %{summary}
Provides:         python3.8dist(docutils)
...
%files -n  python3-bio-docutils -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [docutils] version [0.16] by PackYak v0.0.7
