...
Summary:          PackYak automated build of package = joblib (1.0.1)
...
%files -n  python3-bio-joblib -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [joblib] version [1.0.1] by PackYak v0.0.7
