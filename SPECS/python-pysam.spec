...
Summary:          PackYak v0.0.6 build of Python package [pysam] version [0.16.0.1]
...
%files -n python3-bio-pysam
/usr/lib64/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [pysam] package version to [0.16.0.1-1] by PackYak v0.0.6
