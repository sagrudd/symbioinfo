...
Summary:          PackYak automated build of package = jupyter-core (4.7.1)
...
Summary:        %{summary}
Provides:         python3.8dist(jupyter-core)
...
%files -n  python3-bio-jupyter-core -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [jupyter-core] version [4.7.1] by PackYak v0.0.7
