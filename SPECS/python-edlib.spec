...
Source0:          https://files.pythonhosted.org/packages/61/b7/34e27aad27e1157af1d120b146f9938aa5b0d0beec6506601f090393df52/edlib-1.3.8.post2.tar.gz
License:          MIT
URL:              https://pypi.org/project/edlib/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = edlib (1.3.8.post2)
...
%files -n  python3-bio-edlib -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [edlib] version [1.3.8.post2] by PackYak v0.0.7
