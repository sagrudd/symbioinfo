...
Summary:          PackYak v0.0.6 build of Python package [edlib] version [1.3.8.post2]
...
%files -n python3-bio-edlib
/usr/lib64/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [edlib] package version to [1.3.8.post2-1] by PackYak v0.0.6
