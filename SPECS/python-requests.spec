...
Summary:          PackYak automated build of package = requests (2.25.1)
...
Summary:        %{summary}
Provides:         python3.8dist(requests)
...
%files -n  python3-bio-requests -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [requests] version [2.25.1] by PackYak v0.0.7
