...
Summary:          PackYak v0.0.6 build of Python package [requests] version [2.25.1]
...
Summary:          PackYak v0.0.6 build of Python package [requests] version [2.25.1]
BuildRequires:    python3.8 python3-bio-certifi python3-bio-chardet python3-bio-idna python3-bio-urllib3
Requires:         python3.8 python3-bio-certifi python3-bio-chardet python3-bio-idna python3-bio-urllib3
...
%files -n python3-bio-requests
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Fri Feb 5 2021  <>
- updated [requests] package version to [2.25.1-1] by PackYak v0.0.6
