...
Source0:          https://files.pythonhosted.org/packages/9a/5f/6efabd8509cb3c2041e86a4b0b483d3805b6055480c8b19bae053a2edcee/pyrle-0.0.31.tar.gz
License:          MIT License ([&#39;MIT&#39;])
URL:              https://pypi.org/project/pyrle/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = pyrle (0.0.31)
...
%files -n  python3-bio-pyrle -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pyrle] version [0.0.31] by PackYak v0.0.7
