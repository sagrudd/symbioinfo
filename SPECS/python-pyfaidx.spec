...
Summary:          PackYak v0.0.6 build of Python package [pyfaidx] version [0.5.9.2]
...
Summary:          PackYak v0.0.6 build of Python package [pyfaidx] version [0.5.9.2]
BuildRequires:    python3.8 python3-bio-setuptools python3-bio-six
Requires:         python3.8 python3-bio-setuptools python3-bio-six
...
%files -n python3-bio-pyfaidx
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [pyfaidx] package version to [0.5.9.2-1] by PackYak v0.0.6
