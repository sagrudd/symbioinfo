...
Summary:          PackYak automated build of package = pyasn1 (0.4.8)
...
%files -n  python3-bio-pyasn1 -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pyasn1] version [0.4.8] by PackYak v0.0.7
