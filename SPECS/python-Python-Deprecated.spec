%global packname Python-Deprecated
...
Name:             python-Python-Deprecated
Version:          1.1.0
Release:          %{packrel}%{?dist}
Source0:          https://files.pythonhosted.org/packages/c0/8e/c5875a0cacfcd90151be65e7bf3e08686d67d390c74eb2cc2cdada4974d1/Python-Deprecated-1.1.0.tar.gz
License:          MIT License (MIT)
URL:              https://pypi.org/project/Python-Deprecated/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = Python-Deprecated (1.1.0)
...
Summary:        %{summary}
Provides:         python3.8dist(Python-Deprecated)
...
%files -n  python3-bio-Python-Deprecated -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [Python-Deprecated] version [1.1.0] by PackYak v0.0.7
