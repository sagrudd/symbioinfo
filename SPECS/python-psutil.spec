...
Summary:          PackYak automated build of package = psutil (5.8.0)
...
%files -n  python3-bio-psutil -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [psutil] version [5.8.0] by PackYak v0.0.7
