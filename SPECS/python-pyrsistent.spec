...
Summary:          PackYak automated build of package = pyrsistent (0.17.3)
...
Summary:        %{summary}
Provides:         python3.8dist(pyrsistent)
...
%files -n  python3-bio-pyrsistent -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pyrsistent] version [0.17.3] by PackYak v0.0.7
