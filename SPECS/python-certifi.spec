...
Summary:          PackYak automated build of package = certifi (2020.12.5)
...
Summary:        %{summary}
Provides:         python3.8dist(certifi)
...
%files -n  python3-bio-certifi -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [certifi] version [2020.12.5] by PackYak v0.0.7
