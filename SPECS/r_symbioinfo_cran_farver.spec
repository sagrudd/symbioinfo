...
Summary:          PackYak v0.0.1.9005 build of R-package [farver] version [2.0.3]
...
- updated [farver] package version to [2.0.3-1] by PackYak v0.0.1.9005
