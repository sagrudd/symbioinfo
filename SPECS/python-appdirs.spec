...
Summary:          PackYak automated build of package = appdirs (1.4.4)
...
Summary:        %{summary}
Provides:         python3.8dist(appdirs)
...
%files -n  python3-bio-appdirs -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [appdirs] version [1.4.4] by PackYak v0.0.7
