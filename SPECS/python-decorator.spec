...
Summary:          PackYak automated build of package = decorator (4.4.2)
...
Summary:        %{summary}
Provides:         python3.8dist(decorator)
...
%files -n  python3-bio-decorator -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [decorator] version [4.4.2] by PackYak v0.0.7
