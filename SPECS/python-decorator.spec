...
Summary:          PackYak v0.0.6 build of Python package [decorator] version [4.4.2]
...
%files -n python3-bio-decorator
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/lib/python%{pyversion}/site-packages//__pycache__/decorator.cpython*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [decorator] package version to [4.4.2-1] by PackYak v0.0.6
