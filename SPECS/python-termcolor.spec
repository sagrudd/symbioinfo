...
Summary:          PackYak automated build of package = termcolor (1.1.0)
...
Summary:        %{summary}
Provides:         python3.8dist(termcolor)
...
%files -n  python3-bio-termcolor -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [termcolor] version [1.1.0] by PackYak v0.0.7
