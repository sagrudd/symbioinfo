...
Source0:          https://files.pythonhosted.org/packages/b5/15/a657e32bddf72f69691aa0223df918b5f372eeee709cf8da9be134eac020/toposort-1.6.tar.gz
License:          Apache Software License (Apache License Version 2.0)
URL:              https://pypi.org/project/toposort/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = toposort (1.6)
...
Summary:        %{summary}
Provides:         python3.8dist(toposort)
...
%files -n  python3-bio-toposort -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [toposort] version [1.6] by PackYak v0.0.7
