...
Summary:          PackYak automated build of package = Pillow (8.1.0)
...
%files -n  python3-bio-Pillow -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [Pillow] version [8.1.0] by PackYak v0.0.7
