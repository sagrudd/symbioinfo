...
Summary:          PackYak automated build of package = isal (0.4.0)
...
%files -n  python3-bio-isal -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [isal] version [0.4.0] by PackYak v0.0.7
