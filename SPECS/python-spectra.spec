...
Source0:          https://files.pythonhosted.org/packages/50/50/ae8d87ab681a58e246215e51715566df8074a86d244fee31fa8585fe5f9f/spectra-0.0.11.tar.gz
License:          MIT License (MIT)
URL:              https://pypi.org/project/spectra/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = spectra (0.0.11)
...
Summary:        %{summary}
Provides:         python3.8dist(spectra)
...
%files -n  python3-bio-spectra -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [spectra] version [0.0.11] by PackYak v0.0.7
