...
Summary:          PackYak automated build of package = retrying (1.3.3)
...
Summary:        %{summary}
Provides:         python3.8dist(retrying)
...
%files -n  python3-bio-retrying -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [retrying] version [1.3.3] by PackYak v0.0.7
