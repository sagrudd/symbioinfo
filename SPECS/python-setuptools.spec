...
Summary:          PackYak v0.0.6 build of Python package [setuptools] version [53.0.0]
...
%files -n python3-bio-setuptools
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/lib/python%{pyversion}/site-packages/pkg_resources/*
/usr/lib/python%{pyversion}/site-packages/*distutils*

%changelog
* Thu Feb 4 2021 sagrudd <stephen@mnemosyne.co.uk>
- updated [setuptools] package version to [53.0.0-1] by PackYak v0.0.6
