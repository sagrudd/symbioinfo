...
Summary:          PackYak v0.0.6 build of Python package [pybind11] version [2.6.2]
...
%files -n python3-bio-pybind11
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [pybind11] package version to [2.6.2-1] by PackYak v0.0.6
