...
Source0:          https://cran.r-project.org/web/packages/Rcpp/../../../src/contrib/Rcpp_1.0.6.tar.gz
License:          GPL-2 | GPL-3 [expanded from: GPL (≥ 2)]
URL:              https://cran.r-project.org/web/packages/Rcpp/index.html
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.2 build of R-package [Rcpp] version [1.0.6]
Provides:         R(%{packname})
...
- updated [Rcpp] package version to [1.0.6-1] by PackYak v0.0.2
