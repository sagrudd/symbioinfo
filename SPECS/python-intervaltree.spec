...
Summary:          PackYak v0.0.6 build of Python package [intervaltree] version [3.1.0]
...
Summary:          PackYak v0.0.6 build of Python package [intervaltree] version [3.1.0]
BuildRequires:    python3.8 python3-bio-sortedcontainers
Requires:         python3.8 python3-bio-sortedcontainers
...
%files -n python3-bio-intervaltree
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [intervaltree] package version to [3.1.0-1] by PackYak v0.0.6
