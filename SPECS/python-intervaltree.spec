...
Summary:          PackYak automated build of package = intervaltree (3.1.0)
...
Summary:        %{summary}
Provides:         python3.8dist(intervaltree)
...
%files -n  python3-bio-intervaltree -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [intervaltree] version [3.1.0] by PackYak v0.0.7
