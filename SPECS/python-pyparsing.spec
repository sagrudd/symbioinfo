...
Summary:          PackYak v0.0.6 build of Python package [pyparsing] version [2.4.7]
...
%files -n python3-bio-pyparsing
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/lib/python%{pyversion}/site-packages/__pycache__/pyparsing*

%changelog
* Thu Feb 4 2021 sagrudd <stephen@mnemosyne.co.uk>
- updated [pyparsing] package version to [2.4.7-1] by PackYak v0.0.6
