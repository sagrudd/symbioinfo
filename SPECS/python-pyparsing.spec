...
Summary:          PackYak automated build of package = pyparsing (2.4.7)
...
Summary:        %{summary}
Provides:         python3.8dist(pyparsing)
...
%files -n  python3-bio-pyparsing -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pyparsing] version [2.4.7] by PackYak v0.0.7
