...
Source0:          https://github.com/wimglenn/johnnydep/archive/v1.7.tar.gz
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [johnnydep] version [1.7]
...
Summary:          PackYak v0.0.6 build of Python package [pytz] version [2021.1]
