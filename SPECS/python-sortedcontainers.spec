...
Summary:          PackYak v0.0.6 build of Python package [sortedcontainers] version [2.3.0]
...
%files -n python3-bio-sortedcontainers
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [sortedcontainers] package version to [2.3.0-1] by PackYak v0.0.6
