...
Source0:          https://files.pythonhosted.org/packages/86/f7/a8ad5d723681c3e3fcd3ccdf4a593e4b0c8ff961b9933d612a11ac5b5915/mappy-2.17.tar.gz
License:          MIT License (MIT)
URL:              https://pypi.org/project/mappy/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [mappy] version [2.17]
...
%files -n python3-bio-mappy
/usr/lib64/python%{pyversion}/site-packages/%{packname}*
/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [mappy] package version to [2.17-1] by PackYak v0.0.6
