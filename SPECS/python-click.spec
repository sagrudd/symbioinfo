...
Summary:          PackYak automated build of package = click (7.1.2)
...
%files -n  python3-bio-click -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [click] version [7.1.2] by PackYak v0.0.7
