...
Summary:          PackYak v0.0.6 build of Python package [grpcio] version [1.35.0]
...
Summary:          PackYak v0.0.6 build of Python package [grpcio] version [1.35.0]
BuildRequires:    python3.8 python3-bio-six
Requires:         python3.8 python3-bio-six
...
%files -n python3-bio-grpcio
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [grpcio] package version to [1.35.0-1] by PackYak v0.0.6
