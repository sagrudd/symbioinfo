...
Source0:          https://files.pythonhosted.org/packages/20/b6/36bfb1760f6983788d916096193fc14c83cce512c7787c93380e09458c09/PyVCF-0.6.8.tar.gz
License:          BSD License, MIT License (UNKNOWN)
URL:              https://pypi.org/project/PyVCF/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = PyVCF (0.6.8)
...
%files -n  python3-bio-PyVCF -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [PyVCF] version [0.6.8] by PackYak v0.0.7
