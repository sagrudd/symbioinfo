...
Summary:          PackYak automated build of package = args (0.1.0)
...
%files -n  python3-bio-args -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [args] version [0.1.0] by PackYak v0.0.7
