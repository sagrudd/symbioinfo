...
Source0:          https://files.pythonhosted.org/packages/00/71/c721b9a524f6fe6f73469c90ec44784f0b2b1b23c438da7cc7daac1ede76/oyaml-1.0.tar.gz
License:          MIT
URL:              https://pypi.org/project/oyaml/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [oyaml] version [1.0]
...
Summary:          PackYak v0.0.6 build of Python package [oyaml] version [1.0]
BuildRequires:    python3.8 python3-bio-PyYAML
Requires:         python3.8 python3-bio-PyYAML
...
%files -n python3-bio-oyaml
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/lib/python%{pyversion}/site-packages/__pycache__/oyaml*


%changelog
* Thu Feb 4 2021 sagrudd <stephen@mnemosyne.co.uk>
- updated [oyaml] package version to [1.0-1] by PackYak v0.0.6
