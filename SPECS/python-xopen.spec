...
Summary:          PackYak automated build of package = xopen (1.1.0)
...
%files -n  python3-bio-xopen -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [xopen] version [1.1.0] by PackYak v0.0.7
