...
Source0:          https://files.pythonhosted.org/packages/67/53/404e1039117edc500f32ba6104e2d580e06adf803a9553841fe61f5b110e/xopen-1.1.0.tar.gz
License:          MIT License (MIT)
URL:              https://pypi.org/project/xopen/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [xopen] version [1.1.0]
...
Summary:          PackYak v0.0.6 build of Python package [xopen] version [1.1.0]
BuildRequires:    python3.8 python3-bio-isal
Requires:         python3.8 python3-bio-isal
...
%files -n python3-bio-xopen
/usr/lib/python%{pyversion}/site-packages/%{packname}*
#/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [xopen] package version to [1.1.0-1] by PackYak v0.0.6
