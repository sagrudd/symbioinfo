...
Summary:          PackYak v0.0.2 build of R-package [openssl] version [1.4.3]
Provides:         R(%{packname})
BuildRequires:    tex(latex) R-core = %{rversion} r_askpass
Requires:         tex(latex) R-core = %{rversion} r_askpass
...
- updated [openssl] package version to [1.4.3-1] by PackYak v0.0.2
