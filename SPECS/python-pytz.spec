...
Summary:          PackYak automated build of package = pytz (2021.1)
...
%files -n  python3-bio-pytz -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pytz] version [2021.1] by PackYak v0.0.7
