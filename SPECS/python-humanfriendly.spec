...
Summary:          PackYak automated build of package = humanfriendly (9.1)
...
Summary:        %{summary}
Provides:         python3.8dist(humanfriendly)
...
%files -n  python3-bio-humanfriendly -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [humanfriendly] version [9.1] by PackYak v0.0.7
