...
Name:             r_symbioinfo_cran_nlme
Version:          3.1
Release:          %{packrel}%{?dist}
Source0:          https://cran.r-project.org/web/packages/nlme/../../../src/contrib/nlme_3.1-151.tar.gz
...
Summary:          PackYak build of R-package [nlme] version [3.1-151]
...
- updated [nlme] package version to [3.1-151] by PackYak
