...
Source0:          https://files.pythonhosted.org/packages/5b/e0/b36010bddcf91444ff51179c076e4a09c513674a56758d7cfea4f6520e29/ratelimiter-1.2.0.post0.tar.gz
License:          Apache Software License (Apache)
URL:              https://pypi.org/project/ratelimiter/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = ratelimiter (1.2.0.post0)
...
Summary:        %{summary}
Provides:         python3.8dist(ratelimiter)
...
%files -n  python3-bio-ratelimiter -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [ratelimiter] version [1.2.0.post0] by PackYak v0.0.7
