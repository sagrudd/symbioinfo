...
Source0:          https://files.pythonhosted.org/packages/4d/44/10b21fb51c4b394f8876cbd7831bd1f152c5cec81d70f099250dd30f3704/PuLP-2.4.tar.gz
License:          BSD License
URL:              https://pypi.org/project/PuLP/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = PuLP (2.4)
...
%files -n  python3-bio-PuLP -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [PuLP] version [2.4] by PackYak v0.0.7
