...
Source0:          https://files.pythonhosted.org/packages/49/45/a16db4f0fa383aaf0676fb7e3c660304fe390415c243f41a77c7f917d59b/simplejson-3.17.2.tar.gz
License:          Academic Free License (AFL), MIT License (MIT License)
URL:              https://pypi.org/project/simplejson/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = simplejson (3.17.2)
...
Summary:        %{summary}
Provides:         python3.8dist(simplejson)
...
%files -n  python3-bio-simplejson -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [simplejson] version [3.17.2] by PackYak v0.0.7
