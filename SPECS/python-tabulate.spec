...
Summary:          PackYak v0.0.6 build of Python package [tabulate] version [0.8.7]
...
%files -n python3-bio-tabulate
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/lib/python%{pyversion}/site-packages/__pycache__/tabulate*
/usr/bin/*

%changelog
* Thu Feb 4 2021 sagrudd <stephen@mnemosyne.co.uk>
- updated [tabulate] package version to [0.8.7-1] by PackYak v0.0.6
