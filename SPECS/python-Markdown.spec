...
Summary:          PackYak v0.0.6 build of Python package [Markdown] version [3.3.3]
...
%files -n python3-bio-Markdown
/usr/lib/python%{pyversion}/site-packages/%{packname}*
/usr/lib/python%{pyversion}/site-packages/markdown*
/usr/bin/*

%changelog
* Fri Feb 5 2021 sagrudd <stephen@mnemosyne.co.uk>
- updated [Markdown] package version to [3.3.3-1] by PackYak v0.0.6
