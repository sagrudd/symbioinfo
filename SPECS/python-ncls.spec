...
Source0:          https://files.pythonhosted.org/packages/57/ee/5fdedb4f4211fdf916cfbc9f39ba38075c1916a5df33ee66b2b92334ed87/ncls-0.0.57.tar.gz
License:          New BSD License
URL:              https://pypi.org/project/ncls/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = ncls (0.0.57)
...
%files -n  python3-bio-ncls -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [ncls] version [0.0.57] by PackYak v0.0.7
