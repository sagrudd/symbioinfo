...
Name:             r_symbioinfo_cran_rappdirs
Version:          0.3.1
...
Summary:          PackYak v0.0.1.9005 build of R-package [rappdirs] version [0.3.1]
...
- updated [rappdirs] package version to [0.3.1-1] by PackYak v0.0.1.9005
