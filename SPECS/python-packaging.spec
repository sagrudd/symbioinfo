...
License:          Apache Software License, BSD License (BSD-2-Clause or Apache-2.0)
URL:              https://pypi.org/project/packaging/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [packaging] version [20.9]
...
Summary:          PackYak v0.0.6 build of Python package [packaging] version [20.9]
BuildRequires:    python3.8 python3-bio-pyparsing
Requires:         python3.8 python3-bio-pyparsing
