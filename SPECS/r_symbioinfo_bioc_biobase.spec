...
Name:             r_symbioinfo_bioc_biobase
Version:          2.50.0
Release:          %{packrel}%{?dist}
Source0:          https://www.bioconductor.org/packages/release/bioc/html/../src/contrib/Biobase_2.50.0.tar.gz
License:          Artistic-2.0
URL:              https://www.bioconductor.org/packages/release/bioc/html/Biobase.html
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.1.9005 build of R-package [Biobase] version [2.50.0]
...
- updated [Biobase] package version to [2.50.0-1] by PackYak v0.0.1.9005
