...
Summary:          PackYak automated build of package = GitPython (3.1.13)
...
Summary:        %{summary}
Provides:         python3.8dist(GitPython)
...
%files -n  python3-bio-GitPython -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [GitPython] version [3.1.13] by PackYak v0.0.7
