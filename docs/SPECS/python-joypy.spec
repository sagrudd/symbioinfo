...
Source0:          https://files.pythonhosted.org/packages/45/fc/e00ef1969a924cf6f6684b41337049fe8736db570b4220ff8eabbeb8ea21/joypy-0.2.4.tar.gz
License:          MIT License (MIT)
URL:              https://pypi.org/project/joypy/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = joypy (0.2.4)
...
%files -n  python3-bio-joypy -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [joypy] version [0.2.4] by PackYak v0.0.7
