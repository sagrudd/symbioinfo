...
Summary:          PackYak automated build of package = python-dateutil (2.8.1)
...
Summary:        %{summary}
Provides:         python3.8dist(python-dateutil)
...
%files -n  python3-bio-python-dateutil -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [python-dateutil] version [2.8.1] by PackYak v0.0.7
