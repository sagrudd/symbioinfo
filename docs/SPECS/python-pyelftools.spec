...
Summary:          PackYak v0.0.6 build of Python package [pyelftools] version [0.27]
...
%files -n python3-bio-pyelftools
/usr/lib/python%{pyversion}/site-packages/pyelftools*
/usr/lib/python%{pyversion}/site-packages/elftools*
/usr/bin/*

%changelog
* Thu Feb 4 2021  <>
- updated [pyelftools] package version to [0.27-1] by PackYak v0.0.6
