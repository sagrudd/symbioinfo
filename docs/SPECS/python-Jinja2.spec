...
Summary:          PackYak automated build of package = Jinja2 (2.11.3)
...
%files -n  python3-bio-Jinja2 -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [Jinja2] version [2.11.3] by PackYak v0.0.7
