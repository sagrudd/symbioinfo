...
Source0:          https://files.pythonhosted.org/packages/78/e4/a935f1701fac697c6c5458f86968bec5d2b4cb66e7f738225216ebaa20b4/pandas-1.2.2.tar.gz
License:          BSD
URL:              https://pypi.org/project/pandas/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = pandas (1.2.2)
...
%files -n  python3-bio-pandas
/usr/lib64/python3.8/site-packages/pandas*
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pandas] version [1.2.2] by PackYak v0.0.7
