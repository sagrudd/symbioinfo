...
Source0:          https://files.pythonhosted.org/packages/9d/fe/db74bd405d515f06657f11ad529878fd389576dca4812bea6f98d9b31574/datrie-0.8.2.tar.gz
License:          GNU Lesser General Public License v2 or later (LGPLv2+) (LGPLv2+)
URL:              https://pypi.org/project/datrie/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = datrie (0.8.2)
...
%files -n  python3-bio-datrie -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [datrie] version [0.8.2] by PackYak v0.0.7
