...
License:          Python Software Foundation License (Python license)
URL:              https://pypi.org/project/distlib/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [distlib] version [0.3.1]
