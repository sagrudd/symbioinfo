...
Source0:          https://files.pythonhosted.org/packages/99/5a/fc440eb5fffb5346e61a38b49991aa552e4b8b31e8493a101d2833ed1e19/pysam-0.16.0.1.tar.gz
License:          OSI Approved (MIT)
URL:              https://pypi.org/project/pysam/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = pysam (0.16.0.1)
...
%files -n  python3-bio-pysam -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pysam] version [0.16.0.1] by PackYak v0.0.7
