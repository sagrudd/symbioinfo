...
Summary:          PackYak automated build of package = pycparser (2.20)
...
Summary:        %{summary}
Provides:         python3.8dist(pycparser)
...
%files -n  python3-bio-pycparser -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pycparser] version [2.20] by PackYak v0.0.7
