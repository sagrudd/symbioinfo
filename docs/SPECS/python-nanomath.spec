...
Source0:          https://files.pythonhosted.org/packages/e9/1f/d3cf8ffc9c1ca9b4322619e730fecdecc3ab107f83098becd79f5e24eaba/nanomath-1.2.0.tar.gz
License:          MIT License (GPLv3)
URL:              https://pypi.org/project/nanomath/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = nanomath (1.2.0)
...
Summary:        %{summary}
Provides:         python3.8dist(nanomath)
...
%files -n  python3-bio-nanomath -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [nanomath] version [1.2.0] by PackYak v0.0.7
