...
Summary:          PackYak automated build of package = pytest (6.2.2)
...
Summary:        %{summary}
Provides:         python3.8dist(pytest)
BuildRequires:    python3.8
BuildRequires:    python3-bio-pyparsing
BuildRequires:    python3-bio-toml
BuildRequires:    python3-bio-py
BuildRequires:    python3-bio-pluggy
BuildRequires:    python3-bio-packaging
BuildRequires:    python3-bio-iniconfig
BuildRequires:    python3-bio-attrs
Requires:         python3.8
Requires:         python3-bio-pyparsing
Requires:         python3-bio-toml
Requires:         python3-bio-py
Requires:         python3-bio-pluggy
Requires:         python3-bio-packaging
Requires:         python3-bio-iniconfig
...
%files -n  python3-bio-pytest -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pytest] version [6.2.2] by PackYak v0.0.7
