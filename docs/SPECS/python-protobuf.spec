...
Source0:          https://files.pythonhosted.org/packages/12/ba/d6d9f1432663ab5623f761c86be11e7f2f6fb28348612f48fb082d3cfcea/protobuf-3.14.0.tar.gz
License:          3-Clause BSD License
URL:              https://pypi.org/project/protobuf/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = protobuf (3.14.0)
...
Summary:        %{summary}
Provides:         python3.8dist(protobuf)
...
%files -n  python3-bio-protobuf -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [protobuf] version [3.14.0] by PackYak v0.0.7
