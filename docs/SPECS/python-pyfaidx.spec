...
Source0:          https://files.pythonhosted.org/packages/87/61/0aa146485f1b2ff8fa81122c2bfc0a649bdd39d8ce77c785303937c93e17/pyfaidx-0.5.9.2.tar.gz
License:          BSD License (BSD)
URL:              https://pypi.org/project/pyfaidx/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = pyfaidx (0.5.9.2)
...
Summary:        %{summary}
Provides:         python3.8dist(pyfaidx)
...
%files -n  python3-bio-pyfaidx -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pyfaidx] version [0.5.9.2] by PackYak v0.0.7
