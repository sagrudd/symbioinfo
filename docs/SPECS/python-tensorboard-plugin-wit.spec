%global packname tensorboard-plugin-wit
...
Source0:          https://files.pythonhosted.org/packages/1a/c1/499e600ba0c618b451cd9c425ae1c177249940a2086316552fee7d86c954/tensorboard_plugin_wit-1.8.0-py3-none-any.whl
License:          Apache 2.0
URL:              https://pypi.org/project/tensorboard-plugin-wit/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = tensorboard-plugin-wit (1.8.0)
...
Summary:        %{summary}
Provides:         python3.8dist(tensorboard-plugin-wit)
...
%files -n  python3-bio-tensorboard-plugin-wit
/usr/lib/python3.8/site-packages/tensorboard_plugin_wit*
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [tensorboard-plugin-wit] version [1.8.0] by PackYak v0.0.7
