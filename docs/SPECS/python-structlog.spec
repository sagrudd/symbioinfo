...
Source0:          https://files.pythonhosted.org/packages/4b/98/b6257f65f47d4faa7ef0b58adc40924e66988df2036280f8eac9fc7eb1d9/structlog-20.2.0.tar.gz
License:          Apache Software License, MIT License (MIT or Apache License, Version 2.0)
URL:              https://pypi.org/project/structlog/
Group:            Applications/Bioinformatics
Summary:          PackYak v0.0.6 build of Python package [structlog] version [20.2.0]
