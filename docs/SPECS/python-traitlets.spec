...
Summary:          PackYak automated build of package = traitlets (5.0.5)
...
Summary:        %{summary}
Provides:         python3.8dist(traitlets)
...
%files -n  python3-bio-traitlets -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [traitlets] version [5.0.5] by PackYak v0.0.7
