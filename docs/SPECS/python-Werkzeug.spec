...
Summary:          PackYak automated build of package = Werkzeug (1.0.1)
...
Summary:        %{summary}
Provides:         python3.8dist(werkzeug)
...
%files -n  python3-bio-Werkzeug -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [Werkzeug] version [1.0.1] by PackYak v0.0.7
