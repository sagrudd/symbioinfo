...
Summary:          PackYak automated build of package = future (0.18.2)
...
%files -n  python3-bio-future -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [future] version [0.18.2] by PackYak v0.0.7
