%global packname artic-porechop
...
Name:             python-artic-porechop
Version:          0.3.2pre
Release:          %{packrel}%{?dist}
Source0:          https://github.com/artic-network/Porechop/archive/v0.3.2pre.tar.gz
License:          GPL-3.0
URL:              https://github.com/artic-network/Porechop
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = artic-porechop (0.3.2pre)
...
%prep
%autosetup -p1 -n Porechop-%{version}
...
%files -n  python3-bio-artic-porechop -f INSTALLED_FILES
/usr/lib/python3.8/site-packages/porechop/cpp_functions.so
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [artic-porechop] version [v0.3.2] by PackYak v0.0.7
