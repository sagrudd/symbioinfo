...
Summary:          PackYak automated build of package = py (1.10.0)
...
%files -n  python3-bio-py -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [py] version [1.10.0] by PackYak v0.0.7
