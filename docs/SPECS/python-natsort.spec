...
Summary:          PackYak automated build of package = natsort (7.1.1)
...
Summary:        %{summary}
Provides:         python3.8dist(natsort)
...
%files -n  python3-bio-natsort -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [natsort] version [7.1.1] by PackYak v0.0.7
