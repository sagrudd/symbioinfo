%global packname sorted-nearest
...
Name:             python-sorted-nearest
Version:          0.0.31
Release:          %{packrel}%{?dist}
Source0:          https://files.pythonhosted.org/packages/e7/6e/29a168c3973c54e7de0a98d1680db2c75282b7adbdab7f7562d9395c3b8b/sorted_nearest-0.0.31.tar.gz
License:          New BSD License
URL:              https://pypi.org/project/sorted-nearest/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = sorted-nearest (0.0.31)
...
Summary:        %{summary}
Provides:         python3.8dist(sorted-nearest)
...
%prep
%autosetup -p1 -n sorted_nearest-%{version}
...
%files -n  python3-bio-sorted-nearest -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [sorted-nearest] version [0.0.31] by PackYak v0.0.7
