...
Summary:          PackYak automated build of package = setuptools (53.0.0)
...
Summary:        %{summary}
Provides:         python3.8dist(setuptools)
...
%files -n  python3-bio-setuptools -f INSTALLED_FILES
/usr/lib/python3.8/site-packages/setuptools/*
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [setuptools] version [53.0.0] by PackYak v0.0.7
