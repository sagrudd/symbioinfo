...
Source0:          https://files.pythonhosted.org/packages/bd/8b/951ab577d41d2bb7704e802173ea1de96918894d90636bfdf24477321f4f/fisher-0.1.9.tar.gz
License:          BSD License (BSD)
URL:              https://pypi.org/project/fisher/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = fisher (0.1.9)
...
%files -n  python3-bio-fisher -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [fisher] version [0.1.9] by PackYak v0.0.7
