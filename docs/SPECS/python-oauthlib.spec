...
Summary:          PackYak automated build of package = oauthlib (3.1.0)
...
Summary:        %{summary}
Provides:         python3.8dist(oauthlib)
...
%files -n  python3-bio-oauthlib -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [oauthlib] version [3.1.0] by PackYak v0.0.7
