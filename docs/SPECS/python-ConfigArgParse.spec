%global packname ConfigArgParse
...
Summary:          PackYak automated build of package = ConfigArgParse (1.3)
...
Summary:        %{summary}
Provides:         python3.8dist(ConfigArgParse)
...
%files -n  python3-bio-ConfigArgParse -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [ConfigArgParse] version [1.3] by PackYak v0.0.7
