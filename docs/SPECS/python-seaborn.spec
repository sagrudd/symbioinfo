...
Summary:          PackYak automated build of package = seaborn (0.11.1)
...
Summary:        %{summary}
Provides:         python3.8dist(seaborn)
...
%files -n  python3-bio-seaborn -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [seaborn] version [0.11.1] by PackYak v0.0.7
