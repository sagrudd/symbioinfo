%global packname tensorflow-estimator
...
Source0:          https://files.pythonhosted.org/packages/74/7e/622d9849abf3afb81e482ffc170758742e392ee129ce1540611199a59237/tensorflow_estimator-2.4.0-py2.py3-none-any.whl
License:          Apache Software License (Apache 2.0)
URL:              https://pypi.org/project/tensorflow-estimator/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = tensorflow-estimator (2.4.0)
...
Summary:        %{summary}
Provides:         python3.8dist(tensorflow-estimator)
...
%files -n  python3-bio-tensorflow-estimator
/usr/lib/python3.8/site-packages/tensorflow_estimator*
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [tensorflow-estimator] version [2.4.0] by PackYak v0.0.7
