...
Summary:          PackYak automated build of package = smmap (4.0.0)
...
%files -n  python3-bio-smmap -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [smmap] version [4.0.0] by PackYak v0.0.7
