...
Summary:          PackYak automated build of package = mock (4.0.3)
...
%files -n  python3-bio-mock -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [mock] version [4.0.3] by PackYak v0.0.7
