...
Source0:          https://www.bioconductor.org/packages/release/bioc/html/../src/contrib/limma_3.46.0.tar.gz
License:          GPL (>=2)
...
- updated [limma] package version to [3.46.0-1] by PackYak v0.0.4
