...
Summary:          PackYak automated build of package = attrs (20.3.0)
...
%files -n  python3-bio-attrs -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [attrs] version [20.3.0] by PackYak v0.0.7
