%global packname ipython-genutils
...
Summary:          PackYak automated build of package = ipython-genutils (0.2.0)
...
Summary:        %{summary}
Provides:         python3.8dist(ipython-genutils)
...
%files -n  python3-bio-ipython-genutils -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [ipython-genutils] version [0.2.0] by PackYak v0.0.7
