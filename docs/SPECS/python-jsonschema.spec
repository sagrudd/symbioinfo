...
Summary:          PackYak automated build of package = jsonschema (3.2.0)
...
Summary:        %{summary}
Provides:         python3.8dist(jsonschema)
...
%files -n  python3-bio-jsonschema -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Mon Feb 15 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [jsonschema] version [3.2.0] by PackYak v0.0.7
