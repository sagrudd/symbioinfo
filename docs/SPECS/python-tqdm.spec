...
Source0:          https://files.pythonhosted.org/packages/d4/2a/99ac62cb012d81ffd96a2ddd9eba54d942c56f9244feb58b6a9a49d547d8/tqdm-4.56.2.tar.gz
License:          MIT License, Mozilla Public License 2.0 (MPL 2.0) (MPLv2.0, MIT Licences)
URL:              https://pypi.org/project/tqdm/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = tqdm (4.56.2)
...
%files -n  python3-bio-tqdm -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [tqdm] version [4.56.2] by PackYak v0.0.7
