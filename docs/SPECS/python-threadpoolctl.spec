...
Summary:          PackYak automated build of package = threadpoolctl (2.1.0)
...
Summary:        %{summary}
Provides:         python3.8dist(threadpoolctl)
...
%files -n  python3-bio-threadpoolctl -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Fri Feb 12 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [threadpoolctl] version [2.1.0] by PackYak v0.0.7
