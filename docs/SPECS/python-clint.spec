...
Summary:          PackYak automated build of package = clint (0.5.1)
...
Summary:        %{summary}
Provides:         python3.8dist(clint)
BuildRequires:    python3.8
BuildRequires:    python3-bio-args
Requires:         python3.8
Requires:         python3-bio-args
...
%files -n  python3-bio-clint -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [clint] version [0.5.1] by PackYak v0.0.7
