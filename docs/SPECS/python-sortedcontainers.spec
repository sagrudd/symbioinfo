%global packname sortedcontainers
...
Summary:          PackYak automated build of package = sortedcontainers (2.3.0)
...
Summary:        %{summary}
Provides:         python3.8dist(sortedcontainers)
...
%files -n  python3-bio-sortedcontainers -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [sortedcontainers] version [2.3.0] by PackYak v0.0.7
