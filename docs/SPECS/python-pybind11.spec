...
Summary:          PackYak automated build of package = pybind11 (2.6.2)
...
Summary:        %{summary}
Provides:         python3.8dist(pybind11)
...
%files -n  python3-bio-pybind11 -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [pybind11] version [2.6.2] by PackYak v0.0.7
