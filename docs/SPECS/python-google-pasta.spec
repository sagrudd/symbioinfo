...
Summary:          PackYak automated build of package = google-pasta (0.2.0)
...
Summary:        %{summary}
Provides:         python3.8dist(google-pasta)
...
%files -n  python3-bio-google-pasta -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [google-pasta] version [0.2.0] by PackYak v0.0.7
