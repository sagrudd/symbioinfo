%global packname setuptools-scm
...
Summary:          PackYak automated build of package = setuptools-scm (5.0.1)
...
Summary:        %{summary}
Provides:         python3.8dist(setuptools-scm)
...
%files -n  python3-bio-setuptools-scm -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sat Feb 13 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [setuptools-scm] version [5.0.1] by PackYak v0.0.7
