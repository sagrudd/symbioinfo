...
Source0:          https://files.pythonhosted.org/packages/ce/ef/bfca8e38c1802896f67045a0c9ea0e44fc308b182dbec214b9c2dd54429a/coloredlogs-15.0.tar.gz
License:          MIT License (MIT)
URL:              https://pypi.org/project/coloredlogs/
Group:            Applications/Bioinformatics
Summary:          PackYak automated build of package = coloredlogs (15.0)
...
Summary:        %{summary}
Provides:         python3.8dist(coloredlogs)
...
%files -n  python3-bio-coloredlogs -f INSTALLED_FILES
%defattr(-,root,root)

%changelog
* Sun Feb 14 2021 sagrudd <stephen@mnemosyne.co.uk>
- first build of [coloredlogs] version [15.0] by PackYak v0.0.7
